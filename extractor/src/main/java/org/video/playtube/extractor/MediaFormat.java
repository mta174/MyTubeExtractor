...
/**
 * Static data about various media formats support by PlayTube, eg mime type, extension
 */
...
public enum MediaFormat {
     ...
     *
     * @param ident the id of the media format. Currently an arbitrary, PlayTube-specific number.
