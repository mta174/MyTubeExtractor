...
import org.video.playtube.extractor.util.Parser.RegexException;
...
public class SoundcloudParsingHelper {
    ...
    public static String resolveUrlWithEmbedPlayer(String apiUrl) throws IOException, ReCaptchaException{
        ...
        String response = PlayTube.getDownloader().download("https://w.soundcloud.com/player/?url=" + URLEncoder.encode(apiUrl, ExtractorConstant.CHARSET_UTF_8));
    ...
    public static String resolveIdWithEmbedPlayer(String url) throws IOException, ReCaptchaException, ParsingException {
        ...
        String response = PlayTube.getDownloader().download("https://w.soundcloud.com/player/?url=" + URLEncoder.encode(url, ExtractorConstant.CHARSET_UTF_8));
