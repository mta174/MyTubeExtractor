...
public abstract class SearchQueryHandlerFactory extends ListLinkHandlerFactory {
    ...
    @Override
    public SearchQueryHandler fromQuery(String querry, List<String> contentFilter, String sortFilter) throws ParsingException {
    ...
    /**
     * It's not mandatorry for PlayTube to handle the Url
     * @param url
     * @return
     */
    @Override
