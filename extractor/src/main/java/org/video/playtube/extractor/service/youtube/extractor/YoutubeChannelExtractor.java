...
public class YoutubeChannelExtractor extends ChannelExtractor {
    public static final String TAG = LogHelper.makeLogTag(YoutubeChannelExtractor.class.getSimpleName());
    ...
    public InfoItemsPage<StreamInfoItem> getPage(String pageUrl) throws IOException, ExtractionException {
        ...
        JsonObject ajaxJson;
        try {
            ajaxJson = JsonParser.object().from(PlayTube.getDownloader().download(pageUrl));
