...
import org.video.playtube.extractor.service.youtube.linkHandler.YoutubeParsingHelper;
...
public class YoutubeStreamInfoItemExtractor implements StreamInfoItemExtractor {
    public static final String TAG = LogHelper.makeLogTag(YoutubeStreamInfoItemExtractor.class.getSimpleName());
    ...
    public long getViewCount() throws ParsingException {
        String input;
        try {
            // TODO: Return the actual live streams's watcher count
            // -1 for no view count
            if (getStreamType() == StreamType.LIVE_STREAM) return -1;
        ...
        try {
            ...
            // if this happens the video probably has no view
            if (!input.isEmpty()){
                return 0;
            }
