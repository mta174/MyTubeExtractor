package com.mta.playtube.extractor.linkhandler;
...
public class ListLinkHandler extends LinkHandler {
    ...
    public ListLinkHandler(String originalUrl, String url, String id, List<String> contentFilters, String sortFilter) {
    ...
    public ListLinkHandler(LinkHandler handler, List<String> contentFilters, String sortFilter) {
        this(handler.originalUrl, handler.url, handler.id, contentFilters, sortFilter);
    }
