...
import org.mta.playtube.extractor.*;
import com.mta.playtube.extractor.exceptions.ContentNotAvailableException;
...
import org.mta.playtube.extractor.stream.*;

import com.mta.playtube.extractor.stream.AudioStream;
...
import com.mta.playtube.extractor.stream.SubtitlesStream;
import com.mta.playtube.extractor.stream.VideoStream;
...
public class SoundcloudStreamExtractor extends StreamExtractor {
    ...
    public List<AudioStream> getAudioStreams() throws IOException, ExtractionException {
        ...
        apiUrl.append("https://api.soundcloud.com/i1/tracks/").append(urlEncode(getId()))
                .append("/streams").append("?client_id=").append(urlEncode(SoundcloudParsingHelper.clientId()));
        String response = dl.download(apiUrl.toString());
    ...
    private static String urlEncode(String value) {
        try {
            return URLEncoder.encode(value, ExtractorConstant.CHARSET_UTF_8);
    ...
    public StreamInfoItemsCollector getRelatedStreams() throws IOException, ExtractionException {
        ...
        StringBuffer apiUrl = new StringBuffer();
        apiUrl.append("https://api-v2.soundcloud.com/tracks/").append(urlEncode(getId())).append("/related")
                .append("?client_id=").append(urlEncode(SoundcloudParsingHelper.clientId()));
        SoundcloudParsingHelper.getStreamsFromApi(collector, apiUrl.toString());
        return collector;
    }
