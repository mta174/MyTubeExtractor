...
import com.mta.playtube.extractor.services.youtube.ItagItem;
import org.mta.playtube.extractor.stream.*;

import com.mta.playtube.extractor.stream.AudioStream;
import com.mta.playtube.extractor.stream.Stream;
    ...
    public long getViewCount() throws ParsingException {
        ...
        if(isUseYoutubeApi) {
            if(jsonObject != null) {
                ...
                throw new ParsingException("Could not get number of views");
            }
        }
        else {
            try {
