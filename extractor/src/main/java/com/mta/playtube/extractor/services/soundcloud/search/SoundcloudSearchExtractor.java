...
import com.mta.playtube.extractor.services.soundcloud.playlist.SoundcloudPlaylistInfoItemExtractor;
...
public class SoundcloudSearchExtractor extends SearchExtractor {
    ...
    private String getNextPageUrlFromCurrentUrl(String currentUrl)
        ...
        return currentUrl.replace("&offset=" +
                ...
                "&offset=" + Integer.toString(pageOffset + SoundcloudSearchQueryHandlerFactory.ITEMS_PER_PAGE));
    }
}
